...
fig3.add_trace(go.Scatter(x=df.index, y=df["20RSI"][buy_signal], mode="markers", marker=dict(symbol="triangle-up", size=10, color="green"), name="Buy"), row=2, col=1)

fig3.add_trace(go.Scatter(x=df.index, y=df["20RSI"][sell_signal], mode="markers", marker=dict(symbol="triangle-down", size=10, color="red"), name="Sell"), row=2, col=1)
